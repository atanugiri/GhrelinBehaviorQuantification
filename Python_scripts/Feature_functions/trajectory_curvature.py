...
if __name__ == "__main__":
    ...
    print(f"Testing trajectory curvature for trial {sample_id}")
    curv, mean_curv = compute_trajectory_curvature(dlc_table, sample_id)
    print(f"curvature length: {len(curv)}, mean_curv: {mean_curv}")
