def get_total_feature_sum_per_id(conn, ids, group_label, feature_name='distance', max_time=None):
    """
    For each ID, compute total sum of a given array-like feature (e.g., distance, velocity),
    ...
    Returns:
        pd.DataFrame: Columns = ['id', 'group', f'total_{feature_name}']
    """
    import pandas as pd
    import numpy as np
